...
class CheckoutController extends GetxController {
  ...
  void onInit() {
    ...
    _initializeData(args['products'] != null ? List<Map<String, dynamic>>.from(args['products']) : []);
  }
  ...
  Future<void> _initializeData(List<Map<String, dynamic>> itemsBase) async {
    try {
      ...
      // CHARGEMENT DE TOUS LES PRODUITS RÉELS DE L'API
  ...
  Future<void> _loadFullDetails(List<Map<String, dynamic>> itemsBase) async {
    ...
    for (var item in itemsBase) {
      ...
      if (details != null) {
        ...
        // Restauration des quantités si modification
