...
class CatalogView extends GetView<CatalogController> {
                                ...
                                children: [
                                  ...
                                  if (hasStock)
                                    Container(
                                      ...
                                      child: Text(
                                        "${stockRecharge + stockVente + stockEchange} en stock",
                                        style: TextStyle(
                                          fontSize: 10,
                                          fontWeight: FontWeight.w600,
                                          color: AppColors.generalColor,
  ...
  Widget _buildPriceBadge(String label, int price, int stock, Color color, bool hasStock) {
    return Expanded(
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: 6),
        decoration: BoxDecoration(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 8,
                fontWeight: FontWeight.w600,
                color: hasStock ? color : Colors.grey.shade400,
              ),
            ),
          ],
        ),
                ...
                child: ElevatedButton(
                  onPressed: hasSelection
                      ? () => Get.toNamed(Routes.CHECKOUT, arguments: {
                            'productIds': controller.selectedProductsList
                                .map((e) => e['id'].toString())
                                .toList(),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        hasSelection ? "PASSER AU PAIEMENT" : "SÉLECTIONNER",
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 15,
                        ),
