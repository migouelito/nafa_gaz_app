                                ...
                                children: [
                                  ...
                                  if (hasStock)
                                    Container(
                                      ...
                                      child: Text(
                                        "$stockVente disponible${stockVente > 1 ? 's' : ''}",
                                        style: TextStyle(
                                          fontSize: 10,
                                          fontWeight: FontWeight.w600,
                                          color: AppColors.generalColor,
...
//       appBar: AppBar(
//         title: const Text("Espace d'achat de bouteille",
...
//                   // AFFICHAGE UNIQUE DU PRIX DE VENTE
//                   Column(
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       const Text("PRIX DE VENTE", style: TextStyle(fontSize: 7, color: Colors.black, fontWeight: FontWeight.bold)),
