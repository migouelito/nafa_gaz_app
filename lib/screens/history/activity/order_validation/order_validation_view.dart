...
class OrderValidationView extends GetView<OrderValidationController> {
  ...
  // --- MODIFICATION ICI : UTILISATION DES ADRESSES DE L'API ---
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() {
                      // On cherche le nom correspondant à l'ID sélectionné
                      var selected = controller.addresses.firstWhere(
                        (a) => a['id'].toString() == controller.selectedAddressId.value,
                        orElse: () => null,
                      );
                      return Text(
                        selected != null ? selected['name'] : "Choisir une adresse", 
  ...
  return Container(
    ...
    child: ElevatedButton(
      onPressed: () async {
        ...
        if(isSuccess) Canpop.popMultiple(2);
      },
